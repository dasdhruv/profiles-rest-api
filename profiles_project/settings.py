...
ALLOWED_HOSTS = ['ec2-3-133-106-98.us-east-2.compute.amazonaws.com','127.0.0.1']
...
# Tells the django that look into the profiles_api and then the class UserProfile
# To use the Authentication mechanism and user registration in our project
